...
# Trawl Performance Summary: 2026 Aleutian Islands Survey
...
trawlmetrics_data[["plot_data"]] |>
  ...
  write.csv(here::here("output", paste0("AI", set_year, "_haul_data.csv")), row.names = FALSE)
...
trawlmetrics_data[["trawl_data"]] |>
  ...
  write.csv(here::here("output", paste0("AI", set_year, "_haul_summary.csv")), row.names = FALSE)
...
ragg::agg_png(file = here::here("plots", "ai_trawl_height_width_ts.png"), width = 7, height = 7, res = 300, units = "in")
print(
ggplot() +
  geom_hline(
...
ragg::agg_png(file = here::here("plots", "ai_spread_vs_height.png"), width = 7, height = 7, res = 300, units = "in")
print(
ggplot() +
...
[![Figure 2. Net height and spread for good performance hauls with net measurements in 2026, by haul. Horizontal lines denote the mean (solid line) and 95% range (dashed lines) for hauls from 2005-2026.](./plots/ai_trawl_height_width_ts.png)](%60r%20paste0(%22Trawl%20height%20and%20width%20from%20the%20%22,%20year,%20%22%20%22,%20paste(survey,%20sep%20=%20%22%20and%20%22),%20%22survey(s).%22)%20%60)

![Figure 3. Net spread versus net height for good performance hauls with net measurements from 2005-2026.](./plots/ai_spread_vs_height.png)
